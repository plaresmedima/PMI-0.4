...
PRO PMI__Display__KidneyModelsROI::Fit
...
PRO PMI__Display__KidneyModelsROI::Plot
...
FUNCTION PMI__Display__KidneyModelsROI::Event, ev
...
FUNCTION PMI__Display__Event__KidneyModelsROI, ev

	widget_control, ev.handler, get_uvalue=self
	return, Self -> Event(ev)
END

FUNCTION PMI__Display__KidneyModelsROI::Conc, Region
	case Region of
...
FUNCTION PMI__Display__KidneyModelsROI::GetName, Region
...
PRO PMI__Display__KidneyModelsROI::GET, $
 	CursorPos = CursorPos, $
...
PRO PMI__Display__KidneyModelsROI::SET, $
...
PRO PMI__Display__KidneyModelsROI::Cleanup
	widget_control, self.id, /destroy
	ptr_free, Self.Curve, self.Parameters
	loadct, 0
END

FUNCTION PMI__Display__KidneyModelsROI::Init, parent, CursorPos, xsize=xsize, ysize=ysize
	...
	self.id = widget_base(parent,/column,map=0,event_func='PMI__Display__Event__KidneyModelsROI')
...
PRO PMI__Display__KidneyModelsROI__Define
	...
	Struct = {PMI__Display__KidneyModelsROI 	$
	,	id: 0L 	$
	,	DrawId: 0L $
	,	CursorPos:lonarr(4)	$
...
pro PMI__Button__Event__KidneyModelsROI, ev
	...
	PMI__Control, ev.top, Viewer = 'PMI__Display__KidneyModelsROI', Display=Display
...
pro PMI__Button__Control__KidneyModelsROI, id, v
...
function PMI__Button__KidneyModelsROI, parent,value=value, separator=separator

	PMI__Display__KidneyModelsROI__Define

	if n_elements(value) eq 0 then value = 'Renal filtration models (ROI)'

	return, widget_button(parent, $
		value = value,	$
		event_pro = 'PMI__Button__Event__KidneyModelsROI',	$
		pro_set_value = 'PMI__Button__Control__KidneyModelsROI', $
	 	separator = separator )
end
