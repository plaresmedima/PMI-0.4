...
PRO PMI__Button__FitSingleInletRoiNormAif__Display::Plot
...
FUNCTION PMI__Button__FitSingleInletRoiNormAif__Display::Event, ev
...
FUNCTION PMI__Button__FitSingleInletRoiNormAif__Display__Event, ev
...
FUNCTION PMI__Button__FitSingleInletRoiNormAif__Display::GetCurve, List
...
PRO PMI__Button__FitSingleInletRoiNormAif__Display::SET, $
...
PRO PMI__Button__FitSingleInletRoiNormAif__Display::Cleanup
	widget_control, self.id, /destroy
	ptr_free, Self.Curve, self.Parameters
	loadct, 0
END

FUNCTION PMI__Button__FitSingleInletRoiNormAif__Display::Init, parent, CursorPos, xsize=xsize, ysize=ysize
	...
	self.id = widget_base(parent,/column,map=0,event_func='PMI__Button__FitSingleInletRoiNormAif__Display__Event')
...
PRO PMI__Button__FitSingleInletRoiNormAif__Display__Define

	Struct = {PMI__Button__FitSingleInletRoiNormAif__Display 	$
	,	id: 0L 	$
	,	DrawId: 0L $
	,	CursorPos:lonarr(4)	$
...
pro PMI__Button__Event__FitSingleInletRoiNormAif, ev
...
pro PMI__Button__Control__FitSingleInletRoiNormAif, id, v
...
function PMI__Button__FitSingleInletRoiNormAif, parent,value=value, separator=separator
	...
	,	value = value	$
	,	event_pro = 'PMI__Button__Event__FitSingleInletRoiNormAif'	$
	,	pro_set_value = 'PMI__Button__Control__FitSingleInletRoiNormAif' $
	, 	separator = separator )
	return, id
end