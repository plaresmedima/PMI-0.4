...
FUNCTION PMI__Button__Input__MOCOMO_2D_DCE_2CM, top, series, aif, in, Win, const
...
pro PMI__Button__Event__MOCOMO_2D_DCE_2CM, ev
    ...
    IF NOT PMI__Button__Input__MOCOMO_2D_DCE_2CM(ev.top,series,aif,in,win,const) THEN RETURN
...
pro PMI__Button__Control__MOCOMO_2D_DCE_2CM, id, v
...
function PMI__Button__MOCOMO_2D_DCE_2CM, parent,value=value,separator=separator
    ...
    ,   value = value  $
    ,  	event_pro = 'PMI__Button__Event__MOCOMO_2D_DCE_2CM' $
    ,	pro_set_value = 'PMI__Button__Control__MOCOMO_2D_DCE_2CM' $
    ,  	separator = separator )
