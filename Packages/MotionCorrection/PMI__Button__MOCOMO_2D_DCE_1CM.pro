...
PRO PMI__Button__Obj__MOCOMO_2D_DCE_1CM__DEFINE

  struct = {PMI__Button__Obj__MOCOMO_2D_DCE_1CM, $
  	INHERITS MOCOMO_2D, $
...
tt = systime(1)
    ...
    for k=0L,d[2]-1 do begin
    	...
    	if product(win[k].n) gt 0 then begin
    		...
    		MOCOMO = OBJ_NEW('PMI__Button__Obj__MOCOMO_2D_DCE_1CM', $
...
pro PMI__Button__Control__MOCOMO_2D_DCE_1CM, id, v
...
function PMI__Button__MOCOMO_2D_DCE_1CM, parent,value=value,separator=separator
    ...
    ,   value = value  $
    ,  	event_pro = 'PMI__Button__Event__MOCOMO_2D_DCE_1CM' $
    ,	pro_set_value = 'PMI__Button__Control__MOCOMO_2D_DCE_1CM' $
    ,  	separator = separator )
