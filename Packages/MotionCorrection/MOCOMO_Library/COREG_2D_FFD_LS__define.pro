FUNCTION COREG_2D_FFD_LS::DEF, D
...
FUNCTION COREG_2D_FFD_LS::LSEARCH
...
PRO COREG_2D_FFD_LS::CALCULATE_INTERPOLATION_WEIGHTS
...
PRO COREG_2D_FFD_LS__DEFINE

  struct = {COREG_2D_FFD_LS, $
  	S: ptr_new(), $
  	T: ptr_new(), $
  	F: ptr_new(), $
  	D: ptr_new(), $
