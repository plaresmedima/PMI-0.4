...
;  definition of DP.  The derivative of the *residual* is
;  "-FGRAD(x,p,i) / err" because of how the residual is defined
;  ("resid = (data - model) / err").  **HOWEVER** because of the
;  implementation quirk, the negative of that value should be used.
;  To be clear, the sign of DP should have the same sign as the
;  gradient of F, and the opposite sign of the gradient of RESID.
;
...
;     does not exist.  The gradient matrix, EXTERNAL_FJAC, should be
...
;
;  $Id: mpfit.pro,v 1.48 2007/09/03 06:08:29 craigm Exp $
;-
