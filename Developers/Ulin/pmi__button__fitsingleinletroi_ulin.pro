...
PRO PMI__Button__FitSingleInletRoi_Ulin__Display::Fit
	...
	;	If keyword_set(Pos) then Delay0=0 Else Delay0=-20
		Delay0=0
		DELAY_VALUES=[Delay0,200,time[1]/2]
	ENDIF
...
PRO PMI__Button__FitSingleInletRoi_Ulin__Display::Plot
...
FUNCTION PMI__Button__FitSingleInletRoi_Ulin__Display::Event, ev
...
FUNCTION PMI__Button__FitSingleInletRoi_Ulin__Display__Event, ev
...
FUNCTION PMI__Button__FitSingleInletRoi_Ulin__Display::GetCurve, List
...
FUNCTION PMI__Button__FitSingleInletRoi_Ulin__Display::GetName, List
...
PRO PMI__Button__FitSingleInletRoi_Ulin__Display::GET $
, 	CursorPos = CursorPos $
...
PRO PMI__Button__FitSingleInletRoi_Ulin__Display::SET, $
...
PRO PMI__Button__FitSingleInletRoi_Ulin__Display::Cleanup
	widget_control, self.id, /destroy
	ptr_free, Self.Curve, self.Parameters
	loadct, 0
END

FUNCTION PMI__Button__FitSingleInletRoi_Ulin__Display::Init, parent, CursorPos, xsize=xsize, ysize=ysize
	...
	self.id = widget_base(parent,/column,map=0,event_func='PMI__Button__FitSingleInletRoi_Ulin__Display__Event')
...
PRO PMI__Button__FitSingleInletRoi_Ulin__Display__Define

	Struct = {PMI__Button__FitSingleInletRoi_Ulin__Display 	$
	,	id: 0L 	$
	,	DrawId: 0L $
	,	CursorPos:lonarr(4)	$
...
pro PMI__Button__Event__FitSingleInletRoi_Ulin, ev
	...
	PMI__Control, ev.top, Viewer = 'PMI__Button__FitSingleInletRoi_Ulin__Display', Display=Display
...
pro PMI__Button__Control__FitSingleInletRoi_Ulin, id, v
...
function PMI__Button__FitSingleInletRoi_Ulin, parent,value=value, separator=separator
	...
	,	value = value	$
	,	event_pro = 'PMI__Button__Event__FitSingleInletRoi_Ulin'	$
	,	pro_set_value = 'PMI__Button__Control__FitSingleInletRoi_Ulin' $
	, 	separator = separator )
	return, id
end
