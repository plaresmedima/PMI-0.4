...
pro PMI__Button__Event__TRISTANratVFA, ev
...
pro PMI__Button__Control__TRISTANratVFA, id, v
...
function PMI__Button__TRISTANratVFA, parent, value=value,separator=separator

    if n_elements(value) eq 0 then value = 'VFA T1-mapping'

    id = widget_button(parent $
    ,   value = value  $
    ,  	event_pro = 'PMI__Button__Event__TRISTANratVFA' $
    ,	pro_set_value = 'PMI__Button__Control__TRISTANratVFA' $
    ,  	separator = separator )
