FUNCTION PMI__Button__Input__FitT1SaturationRecoveryPixel, top, series
...
pro PMI__Button__Event__FitT1SaturationRecoveryPixel, ev

	PMI__Message, status, 'Preparing calculation..'

    IF NOT PMI__Button__Input__FitT1SaturationRecoveryPixel(ev.top,series) THEN goto, exit
...
pro PMI__Button__Control__FitT1SaturationRecoveryPixel, id, v
...
function PMI__Button__FitT1SaturationRecoveryPixel, parent, value=value,separator=separator
    ...
    ,   value = value  $
    ,  	event_pro = 'PMI__Button__Event__FitT1SaturationRecoveryPixel' $
    ,	pro_set_value = 'PMI__Button__Control__FitT1SaturationRecoveryPixel' $
    ,  	separator = separator )
