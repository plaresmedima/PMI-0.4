...
;
;
pro PMI__Button__Event__TRISTAN_SlicesResolution, ev
...
PRO PMI__Button__Control__TRISTAN_SlicesResolution, id, v

	PMI__Info, tlb(id), Series=Series
    widget_control, id, sensitive=obj_valid(Series)
END

function PMI__Button__TRISTAN_SlicesResolution,$
 	parent,$
 	separator=separator,$
 	value=value
    ...
    return, widget_button(parent, $
      	separator = separator, $
      	value = value, $
      	event_pro = 'PMI__Button__Event__TRISTAN_SlicesResolution',$
      	pro_set_value =  'PMI__Button__Control__TRISTAN_SlicesResolution')
end
