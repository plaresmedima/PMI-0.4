...
pro PMI__Menu__TRISTANRATS, parent
	...
	Sid = PMI__Button__TristanRatsRoi_v3_2(id, value='Fit Rat Gadoxetate model v3.2')

	Sid = PMI__Button__TristanRatVFA(id, value='Variable Flip Angle T1-mapping', /separator)
;	Sid = PMI__Button__TristanRatsRoi_v3_1(id, value='Fit Rat Gadoxetate model v3.1 (OBSOLETE - for comparison only)')
