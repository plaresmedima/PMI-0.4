...
PRO PMI__Button__Anup_FitSingleInletRoi__Display::Fit
	...
	IF Delay NE 0 THEN DELAY_VALUES=[0,20,time[1]/2]
...
PRO PMI__Button__Anup_FitSingleInletRoi__Display::Plot
...
FUNCTION PMI__Button__Anup_FitSingleInletRoi__Display::Event, ev
...
FUNCTION PMI__Button__Anup_FitSingleInletRoi__Display__Event, ev

	widget_control, ev.handler, get_uvalue=self
	return, Self -> Event(ev)
END

FUNCTION PMI__Button__Anup_FitSingleInletRoi__Display::Conc, Region
...
;	Self -> GET, SignalModel=SignalModel
	...
	case Region of
		'ROI':begin
			R10 = 1/self.tissueT1 ; per msec
			end
		'AIF':begin
			R10 = 1/self.bloodT1 ; per msec
			end
	endcase
...
FUNCTION PMI__Button__Anup_FitSingleInletRoi__Display::GetCurve, Region
...
FUNCTION PMI__Button__Anup_FitSingleInletRoi__Display::GetName, Region
...
PRO PMI__Button__Anup_FitSingleInletRoi__Display::GET $
, 	CursorPos = CursorPos $
...
PRO PMI__Button__Anup_FitSingleInletRoi__Display::SET, $
	...
	tissueT1=tissueT1, bloodT1=bloodT1, $
	OnDisplay=OnDisplay
	...
	if n_elements(tissueT1) ne 0 then self.tissueT1 = tissueT1
	if n_elements(bloodT1) ne 0 then self.tissueT1 = bloodT1
...
PRO PMI__Button__Anup_FitSingleInletRoi__Display::Cleanup
	widget_control, self.id, /destroy
	ptr_free, Self.Curve, self.Parameters
	loadct, 0
END

FUNCTION PMI__Button__Anup_FitSingleInletRoi__Display::Init, parent, CursorPos, xsize=xsize, ysize=ysize
	...
	self.DrawId	= widget_draw(self.id,/retain)
        ...
        models = ['Uptake', 'Patlak', 'Compartment','Tofts','Modified Tofts','2C Uptake','2C Exchange']
...
PRO PMI__Button__Anup_FitSingleInletRoi__Display__Define

	Struct = {PMI__Button__Anup_FitSingleInletRoi__Display 	$
	,	id: 0L 	$
	,	DrawId: 0L $
	,	CursorPos:lonarr(4)	$
...
pro PMI__Button__Event__Anup_FitSingleInletRoi, ev
	...
	v = PMI__Form(ev.top, Title='Perfusion analysis setup', [$
		...
		ptr_new({Type:'VALUE'	,Tag:'T1tissue' , Label:'Tissue T1 (ms)', Value:1000E}), $
		ptr_new({Type:'VALUE'	,Tag:'T1blood' , Label:'Blood T1 (ms)', Value:1440E})])
	IF v.cancel THEN return

	PMI__Control, ev.top, Viewer = 'PMI__Button__Anup_FitSingleInletRoi__Display', Display=Display
...
pro PMI__Button__Control__Anup_FitSingleInletRoi, id, v
...
function PMI__Button__Anup_FitSingleInletRoi, parent,value=value, separator=separator
	...
	,	value = value	$
	,	event_pro = 'PMI__Button__Event__Anup_FitSingleInletRoi'	$
	,	pro_set_value = 'PMI__Button__Control__Anup_FitSingleInletRoi' $
	, 	separator = separator )
	return, id
end
