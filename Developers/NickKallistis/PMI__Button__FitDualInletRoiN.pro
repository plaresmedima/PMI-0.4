...
PRO PMI__Button__Display__FitDualInletRoi::Fit
...
PRO PMI__Button__Display__FitDualInletRoi::Plot
...
FUNCTION PMI__Button__Display__FitDualInletRoi::Event, ev
...
FUNCTION PMI__Button__Display__Event__FitDualInletRoi, ev
...
FUNCTION PMI__Button__Display__FitDualInletRoi::GetCurve, List
...
FUNCTION PMI__Button__Display__FitDualInletRoi::GetName, List
...
PRO PMI__Button__Display__FitDualInletRoi::GET $
, 	CursorPos = CursorPos $
...
PRO PMI__Button__Display__FitDualInletRoi::SET, $
...
PRO PMI__Button__Display__FitDualInletRoi::Cleanup
	widget_control, self.id, /destroy
	ptr_free, Self.Curve, self.Parameters
	loadct, 0
END

FUNCTION PMI__Button__Display__FitDualInletRoi::Init, parent, CursorPos, xsize=xsize, ysize=ysize
	...
	self.id = widget_base(parent,/column,map=0,event_func='PMI__Button__Display__Event__FitDualInletRoi')
...
PRO PMI__Button__Display__FitDualInletRoi__Define
	...
	Struct = {PMI__Button__Display__FitDualInletRoi 	$
	,	id: 0L 	$
	,	DrawId: 0L $
	,	CursorPos:lonarr(4)	$
...
pro PMI__Button__Event__FitDualInletRoi, ev
	...
	PMI__Control, ev.top, Viewer = 'PMI__Button__Display__FitDualInletRoi', Display=Display
...
pro PMI__Button__Control__FitDualInletRoi, id, v
...
function PMI__Button__FitDualInletRoiN, parent,value=value, separator=separator

	PMI__Button__Display__FitDualInletRoi__Define

	if n_elements(value) eq 0 then value = 'Fit dual-inlet models (ROI)'

	id = widget_button(parent $
	,	value = value	$
	,	event_pro = 'PMI__Button__Event__FitDualInletRoi'	$
	,	pro_set_value = 'PMI__Button__Control__FitDualInletRoi' $
	, 	separator = separator)
