...
PRO PMI__Display__KidneyModelsROI_iBEAt::Fit
...
PRO PMI__Display__KidneyModelsROI_iBEAt::Plot
...
FUNCTION PMI__Display__KidneyModelsROI_iBEAt::Event, ev
...
FUNCTION PMI__Display__Event__KidneyModelsROI_iBEAt, ev

	widget_control, ev.handler, get_uvalue=self
	return, Self -> Event(ev)
END

FUNCTION PMI__Display__KidneyModelsROI_iBEAt::Conc, Region
	case Region of
...
FUNCTION PMI__Display__KidneyModelsROI_iBEAt::GetCurve, Region
...
FUNCTION PMI__Display__KidneyModelsROI_iBEAt::GetName, Region
...
PRO PMI__Display__KidneyModelsROI_iBEAt::GET, $
 	CursorPos = CursorPos, $
...
PRO PMI__Display__KidneyModelsROI_iBEAt::SET, $
...
PRO PMI__Display__KidneyModelsROI_iBEAt::Cleanup
	widget_control, self.id, /destroy
	ptr_free, Self.Curve, self.Parameters
	loadct, 0
END

FUNCTION PMI__Display__KidneyModelsROI_iBEAt::Init, parent, CursorPos, xsize=xsize, ysize=ysize
	...
	self.id = widget_base(parent,/column,map=0,event_func='PMI__Display__Event__KidneyModelsROI_iBEAt')
...
PRO PMI__Display__KidneyModelsROI_iBEAt__Define
	...
	Struct = {PMI__Display__KidneyModelsROI_iBEAt 	$
	,	id: 0L 	$
	,	DrawId: 0L $
	,	CursorPos:lonarr(4)	$
...
pro PMI__Button__Event__KidneyModelsROI_iBEAt, ev
	...
	PMI__Control, ev.top, Viewer = 'PMI__Display__KidneyModelsROI_iBEAt', Display=Display
...
pro PMI__Button__Control__KidneyModelsROI_iBEAt, id, v
...
function PMI__Button__KidneyModelsROI_iBEAt, parent,value=value, separator=separator

	PMI__Display__KidneyModelsROI_iBEAt__Define

	if n_elements(value) eq 0 then value = 'Renal filtration models (ROI)'

	return, widget_button(parent, $
		value = value,	$
		event_pro = 'PMI__Button__Event__KidneyModelsROI_iBEAt',	$
		pro_set_value = 'PMI__Button__Control__KidneyModelsROI_iBEAt', $
	 	separator = separator )
end
