...
pro iBEAt_Import_Leeds_10_5__LoadT1W, Sequence, Stdy, files, Series, status
...
pro iBEAt_Import_Leeds_10_5__LoadDixon, Sequence, Stdy, files, Series, status
...
pro iBEAt_Import_Leeds_10_5__LoadMTmapping, Seq, Stdy, files, Series, status
...
pro iBEAt_Import_Leeds_10_5__LoadPhaseContrast, Sequence, Stdy, files, Series, status
...
pro iBEAt_Import_Leeds_10_5__LoadT2mapping, Sequence, Stdy, files, Series, status
...
pro iBEAt_Import_Leeds_10_5__LoadInversionRecovery, Sequence, Stdy, files, Series, status
...
pro iBEAt_Import_Leeds_10_5__LoadVolume, Sequence, Stdy, files, Series, status
...
pro iBEAt_Import_Leeds_10_5__LoadSequence, Sequence, SortBy=SortBy, Stdy, files, first, status
...
pro iBEAt_Import_Leeds_10_5, Stdy, files, first, status=status
...
;;;;LOAD THE SERIES
	...
	iBEAt_Import_Leeds_10_5__LoadSequence, seq1, Sortby=['Image number','Acquisition time'], Stdy, files, first, status
	iBEAt_Import_Leeds_10_5__LoadSequence, seq2, Sortby=['Image number','Acquisition time'], Stdy, files, first, status
	iBEAt_Import_Leeds_10_5__LoadVolume, seq3, Stdy, files, Series, status
	iBEAt_Import_Leeds_10_5__LoadDixon, seq4, Stdy, files, Series, status
	iBEAt_Import_Leeds_10_5__LoadSequence, seq5, Sortby=['Slice location','Echo time'], Stdy, files, first, status
	iBEAt_Import_Leeds_10_5__LoadT1W, seq6, Stdy, files, Series, status
	iBEAt_Import_Leeds_10_5__LoadInversionRecovery, seq7, Stdy, files, Series, status
	iBEAt_Import_Leeds_10_5__LoadSequence, seq8, Sortby=['Slice location','Echo time'], Stdy, files, first, status
	iBEAt_Import_Leeds_10_5__LoadT2mapping, seq9, Stdy, files, series, status
	iBEAt_Import_Leeds_10_5__LoadMTmapping, seq10, Stdy, files, series, status
	iBEAt_Import_Leeds_10_5__LoadSequence, seq11, Stdy, files, first, status
	iBEAt_Import_Leeds_10_5__LoadSequence, seq12, Stdy, files, first, status
	iBEAt_Import_Leeds_10_5__LoadSequence, seq13, Stdy, files, first, status
	iBEAt_Import_Leeds_10_5__LoadSequence, seq14, Stdy, files, first, status
	iBEAt_Import_Leeds_10_5__LoadPhaseContrast, seq15, Stdy, files, series, status
	iBEAt_Import_Leeds_10_5__LoadPhaseContrast, seq16, Stdy, files, series, status
	iBEAt_Import_Leeds_10_5__LoadSequence, seq17, Stdy, files, first, status
	iBEAt_Import_Leeds_10_5__LoadSequence, seq18, Stdy, files, first, status
	iBEAt_Import_Leeds_10_5__LoadDixon, seq19, Stdy, files, Series, status
