PRO split_into_four_segments, bin, p1, seg1=bin1, seg2=bin2, seg3=bin3, seg4=bin4
  ...
  for y=0L, dim[1]-1 do begin
    if bin[x,y] eq 1 then begin
      ...
      if ax ge 270 then bin1[x,y]=1 else $
      if ax ge 180 then bin4[x,y]=1 else $
      if ax ge 90 then bin3[x,y]=1 else $
