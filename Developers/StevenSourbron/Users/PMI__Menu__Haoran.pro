...
pro PMI__Menu__Haoran, parent
	...
	id = widget_button(parent, value='Haoran',/menu)

    Sid = PMI__Button__DCEurLAB(id, value='DCE@urLAB analysis (Pixel)')
    Sid = PMI__Button__RoiDCEurLAB(id, value='DCE@urLAB analysis (ROI)')
