...
pro PMI__Menu__Christian, parent
	...
	id = widget_button(parent, value='Christian',/menu)

	Sid = PMI__Button__ChristianKidneyModelsROI(id, value = 'Christian kidney models (ROI)')
