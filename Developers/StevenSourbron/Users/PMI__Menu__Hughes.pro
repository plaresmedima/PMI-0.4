...
pro PMI__Menu__Hughes, parent
	...
	Sid = PMI__Button__MOCOMO_2D_DCE_2CM(id, value='2D DCE motion correction (2CM)', /separator)
	Sid = PMI__Button__MOCOMO_2D_DCEModelFree(id, value='2D DCE motion correction (Model-free)')
