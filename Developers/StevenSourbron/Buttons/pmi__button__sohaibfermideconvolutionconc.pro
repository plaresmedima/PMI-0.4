...
FUNCTION PMI__Button__Input__sohaibfermideconvolutionconc, top, series, aif, roi, in
...
pro PMI__Button__Event__sohaibfermideconvolutionconc, ev

	PMI__Info, ev.top, Status=Status, Stdy=Stdy
	PMI__Message, status, 'Preparing calculation..'

    IF NOT PMI__Button__Input__sohaibfermideconvolutionconc(ev.top,series,aif,roi,in) THEN RETURN

	PMI__Message, status, 'Calculating..'

	Dom = {z:Series->z(), t:Series->t(0), m:Series->m()}
    Sbf = Stdy->New('SERIES', Domain= Dom,  Name= 'Fermi-Gd: Blood Flow (ml/min/g)' )
...
pro PMI__Button__Control__sohaibfermideconvolutionconc, id, v
...
function PMI__Button__sohaibfermideconvolutionconc, parent,value=value,separator=separator
    ...
    ,   value = value  $
    ,  	event_pro = 'PMI__Button__Event__sohaibfermideconvolutionconc' $
    ,	pro_set_value = 'PMI__Button__Control__sohaibfermideconvolutionconc' $
    ,  	separator = separator )
