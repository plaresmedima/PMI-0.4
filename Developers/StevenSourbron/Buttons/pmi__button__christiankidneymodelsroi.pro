...
PRO PMI__Display__ChristianKidneyModelsROI::Fit
...
PRO PMI__Display__ChristianKidneyModelsROI::Plot
...
FUNCTION PMI__Display__ChristianKidneyModelsROI::Event, ev
...
FUNCTION PMI__Display__Event__ChristianKidneyModelsROI, ev

	widget_control, ev.handler, get_uvalue=self
	return, Self -> Event(ev)
END

FUNCTION PMI__Display__ChristianKidneyModelsROI::Conc, Region
	...
	endcase
	if SignalModel eq 2 then begin
...
FUNCTION PMI__Display__ChristianKidneyModelsROI::GetCurve, Region
...
FUNCTION PMI__Display__ChristianKidneyModelsROI::GetName, Region
...
PRO PMI__Display__ChristianKidneyModelsROI::GET, $
 	CursorPos = CursorPos, $
...
PRO PMI__Display__ChristianKidneyModelsROI::SET, $
...
PRO PMI__Display__ChristianKidneyModelsROI::Cleanup
	widget_control, self.id, /destroy
	ptr_free, Self.Curve, self.Parameters
	loadct, 0
END

FUNCTION PMI__Display__ChristianKidneyModelsROI::Init, parent, CursorPos, xsize=xsize, ysize=ysize
	...
	self.id = widget_base(parent,/column,map=0,event_func='PMI__Display__Event__ChristianKidneyModelsROI')
...
PRO PMI__Display__ChristianKidneyModelsROI__Define
	...
	Struct = {PMI__Display__ChristianKidneyModelsROI 	$
	,	id: 0L 	$
	,	DrawId: 0L $
	,	CursorPos:lonarr(4)	$
...
pro PMI__Button__Event__ChristianKidneyModelsROI, ev
...
pro PMI__Button__Control__ChristianKidneyModelsROI, id, v
...
function PMI__Button__ChristianKidneyModelsROI, parent,value=value, separator=separator

	PMI__Display__ChristianKidneyModelsROI__Define

	if n_elements(value) eq 0 then value = 'Renal filtration models (ROI)'

	return, widget_button(parent, $
		value = value,	$
		event_pro = 'PMI__Button__Event__ChristianKidneyModelsROI',	$
		pro_set_value = 'PMI__Button__Control__ChristianKidneyModelsROI', $
	 	separator = separator )
end
