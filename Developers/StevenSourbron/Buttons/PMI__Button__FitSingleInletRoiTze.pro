PRO PMI__Button__FitSingleInletRoiTze__Display::Fit
...
PRO PMI__Button__FitSingleInletRoiTze__Display::Plot
...
FUNCTION PMI__Button__FitSingleInletRoiTze__Display::Event, ev
...
FUNCTION PMI__Button__FitSingleInletRoiTze__Display__Event, ev
...
FUNCTION PMI__Button__FitSingleInletRoiTze__Display::Conc, Signal, List
...
FUNCTION PMI__Button__FitSingleInletRoiTze__Display::GetRegion, List
...
FUNCTION PMI__Button__FitSingleInletRoiTze__Display::GetCurve, List
...
FUNCTION PMI__Button__FitSingleInletRoiTze__Display::GetName, List
...
PRO PMI__Button__FitSingleInletRoiTze__Display::GET $
, 	CursorPos = CursorPos $
...
PRO PMI__Button__FitSingleInletRoiTze__Display::SET, $
...
PRO PMI__Button__FitSingleInletRoiTze__Display::Cleanup
	widget_control, self.id, /destroy
	ptr_free, Self.Curve, self.Parameters
	loadct, 0
END

FUNCTION PMI__Button__FitSingleInletRoiTze__Display::Init, parent, CursorPos, xsize=xsize, ysize=ysize
	...
	self.id = widget_base(parent,/column,map=0,event_func='PMI__Button__FitSingleInletRoiTze__Display__Event')
...
PRO PMI__Button__FitSingleInletRoiTze__Display__Define

	Struct = {PMI__Button__FitSingleInletRoiTze__Display 	$
	,	id: 0L 	$
	,	DrawId: 0L $
	,	CursorPos:lonarr(4)	$
...
FUNCTION PMI__Button__Input__FitSingleInletRoiTze, top, series, in
...
pro PMI__Button__Event__FitSingleInletRoiTze, ev

	IF NOT PMI__Button__Input__FitSingleInletRoiTze(ev.top, series, in) THEN return

	PMI__Control, ev.top, Viewer = 'PMI__Button__FitSingleInletRoiTze__Display', Display=Display
...
pro PMI__Button__Control__FitSingleInletRoiTze, id, v
...
function PMI__Button__FitSingleInletRoiTze, parent,value=value, separator=separator
	...
	,	value = value	$
	,	event_pro = 'PMI__Button__Event__FitSingleInletRoiTze'	$
	,	pro_set_value = 'PMI__Button__Control__FitSingleInletRoiTze' $
	, 	separator = separator )
	return, id
end
