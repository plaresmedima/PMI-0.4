pro PMI__Button__Event__FitFiltrationDimitraNLLS, ev
	...
	for i=0L,n-1 do begin
        ...
        RENALMODEL_INVERSE_NONLINEAR_4_PARAMETERS, reform(p[i,*]), aif, time, Tprec, TTrec, VPrec, VTrec
...
pro PMI__Button__Control__FitFiltrationDimitraNLLS, id, v
...
function PMI__Button__FitFiltrationDimitraNLLS, parent,value=value, separator=separator
	...
	,	value 		= value		$
	,	event_pro 	= 'PMI__Button__Event__FitFiltrationDimitraNLLS'	$
	,	pro_set_value 	= 'PMI__Button__Control__FitFiltrationDimitraNLLS' $
	, 	separator 	= separator						)
