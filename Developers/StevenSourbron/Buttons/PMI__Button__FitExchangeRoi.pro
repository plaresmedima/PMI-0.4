function PMI__Button__Input__FitExchangeRoi $
, 	top $
,	Status	 = id $
,	time	 = time $
,	curve 	 = roicurve $
...
pro PMI__Button__Event__FitExchangeRoi, ev

  PMI__Info, ev.top, stdy=Stdy

  if not PMI__Button__Input__FitExchangeRoi($
     ev.top $
     ,	Status	= status $
     ,	time 	= time $
     ,	curve 	= curve $
...
pro PMI__Button__Control__FitExchangeRoi, id, v
...
function PMI__Button__FitExchangeRoi, parent,value=value, separator=separator
	...
	,	value 		= value		$
	,	event_pro 	= 'PMI__Button__Event__FitExchangeRoi'	$
	,	pro_set_value 	= 'PMI__Button__Control__FitExchangeRoi' $
	, 	separator 	= separator						)
	return, id
end
