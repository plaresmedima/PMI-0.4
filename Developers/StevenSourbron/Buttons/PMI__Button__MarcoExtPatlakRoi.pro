FUNCTION PMI__Button__Input__MarcoExtPatlakRoi, top, time, aif, curve, RoiName = RoiName
...
pro PMI__Button__Event__MarcoExtPatlakRoi, ev
    ...
    IF NOT PMI__Button__Input__MarcoExtPatlakRoi(ev.top, time, aif, curve, RoiName=RoiName) THEN RETURN
	...
	,	Parameters = $
		...
		,{Name:'Intracellular Clearance Rate', Units:'/100/min', Value:6000D*Ktrans/ve, Nr:2, Rnd:1} ]
