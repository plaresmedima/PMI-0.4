pro PMI__Button__Event__FitToftsRoi, ev
	...
	Fit = FitSingleInlet('Compartment', time, aif, curve, P, AKAIKE_ERROR=aic, /POSITIVITY, LIMITED_ABOVE=[1,0])
...
pro PMI__Button__Control__FitToftsRoi, id, v
...
function PMI__Button__FitToftsRoi, parent,value=value, separator=separator
	...
	,	value 		= value	$
	,	event_pro 	= 'PMI__Button__Event__FitToftsRoi'	$
	,	pro_set_value 	= 'PMI__Button__Control__FitToftsRoi' $
	, 	separator 	= separator	)
