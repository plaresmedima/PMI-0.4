Pro PMI__Button__Event__FitModifiedToftsRoi, ev
	...
	Fit = FitSingleInlet('ModifiedTofts', time, aif, curve, P, AKAIKE_ERROR=aic, /POSITIVITY, LIMITED_ABOVE=[1,1,0])

	PMI__Control, ev.top, Viewer = 'PMI__Display__PerfusionRoiOutput', Display=Display

	Display -> Set, /Refresh $
	,	Model = 'Modified Tofts model' $
	,	Time = Time $
	,	Curve = Curve $
	,	Fit = Fit $
	,	Units = Units $
...
pro PMI__Button__Control__FitModifiedToftsRoi, id, v
...
function PMI__Button__FitModifiedToftsRoi, parent,value=value, separator=separator

	SingleInletModifiedTofts
	PMI__Display__PerfusionRoiOutput__Define

	if n_elements(value) eq 0 then value = 'Fit Modified Tofts model (ROI)'

	id = widget_button(parent 						$
	,	value 		= value		$
	,	event_pro 	= 'PMI__Button__Event__FitModifiedToftsRoi'	$
	,	pro_set_value 	= 'PMI__Button__Control__FitModifiedToftsRoi' $
	, 	separator 	= separator						)
