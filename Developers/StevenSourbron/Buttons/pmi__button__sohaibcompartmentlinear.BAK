...
FUNCTION PMI__Button__Input__sohaibcompartmentlinear, top, series, aif, in
...
pro PMI__Button__Event__sohaibcompartmentlinear, ev
    ...
    IF NOT PMI__Button__Input__sohaibcompartmentlinear(ev.top,series,aif,in) THEN RETURN
