...
pro PMI__Menu__Leonidas, parent

	PMI__Menu__Skeleton, parent
	PMI__Menu__Slices, parent
	PMI__Menu__Dynamic, parent

	id = widget_button(parent, value='Leo',/menu)
    ...
    Sid = PMI__Button__AnitaSemiQuantitativePerfusion(id	, value='New SemiQuant (Pixel)', /separator)
    Sid = PMI__Button__HelloWorld(id, value='Hello World')
    Sid = PMI__Button__SimpleSmooth(id, value='Simple smooth')
    Sid = PMI__Button__SlicesAxialToCoronal(id, value='Reconstruct Ax -> Cor')

	Sid = PMI__Button__MultiplyData(id, value='Multiply *5')
	Sid = PMI__Button__MultiplyVariable(id, value='Multiply or divide')

	Sid = PMI__Button__AnitaRegionShrink(id, value='Auto AIF')
end
