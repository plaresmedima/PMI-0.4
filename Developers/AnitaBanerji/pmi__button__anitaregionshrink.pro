...
pro PMI__Button__Event__AnitaRegionShrink, ev
...
pro PMI__Button__Control__AnitaRegionShrink, id, v
...
function PMI__Button__AnitaRegionShrink, parent, separator=separator, value=value

	if n_elements(value) eq 0 then value  = 'Shrink'

  	id = widget_button(parent, separator = separator, value = value, $
		pro_set_value = 'PMI__Button__Control__AnitaRegionShrink', $
