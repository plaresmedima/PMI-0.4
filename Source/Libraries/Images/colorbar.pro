    ...
    IF KEYWORD_SET(vertical) THEN BEGIN
       ...
       IF KEYWORD_SET(right) THEN BEGIN
          ...
          PLOT, [minrange,maxrange], [minrange,maxrange], /NODATA, XTICKS=1, $
             ...
             YTICKNAME=ticknames, FONT=font, YLOG=ylog, Background = 0
       ...
       ENDIF ELSE BEGIN
        ...
        !P.font = 0
          ...
          PLOT, [minrange,maxrange], [minrange,maxrange], /NODATA, XTICKS=1,  $
             YTICKS=divisions, XTITLE = unit, YSTYLE=1, XSTYLE=1, TITLE=title, $
             POSITION=position, COLOR=255, CHARSIZE=charsize, /NOERASE, $
    ...
    ENDIF ELSE BEGIN
       ...
       ENDIF ELSE BEGIN
          ...
          PLOT, [minrange,maxrange], [minrange,maxrange], /NODATA, XTICKS=divisions, $
             ...
             XRANGE=[minrange, maxrange], FONT=font, XMinor=minor, _EXTRA=extra, $
             XTICKNAME=ticknames, XLOG=xlog, Background =60
