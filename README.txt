...
2. To create a runtime version of PMI: open IDL, type "pmi__compile" in the command line, and save in the folder "/PMI-0.4-runtime"

3. To run the runtime version: double-click on the file "/PMI-0.4-runtime/pmi.sav" (no need to open IDL first)
